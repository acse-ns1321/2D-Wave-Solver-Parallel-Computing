...
//	stringstream fname;
//	fstream f1;
//	fname << "./output/serial/output" << "_" << out << ".dat";
...
//{
//	//  Updating inner part of the domain
...
//
//	// Updating the outer columns of the domain
//	for (int i = 0; i < imax; i++)
//	{
...
//	}
//
//	// Updating the rows of the domain
//	for (int j = 0; j < jmax; j++)
//	{
...
//	t += dt;
//
//	old_grid.swap(new_grid); // swap elements of old grid with new grid
//	old_grid.swap(grid); // 
//}
//
